...
<div class="wrap J_check_wrap">
	<ul class="nav nav-tabs">
     ...
     <li><a href="index.php?r=rbac/addrole">添加角色</a></li>
  	 <li class="active"><a href="index.php?r=rbac/addauth">添加权限</a></li>
  </ul>
  <a class="newadd" href=""> 新增加</a>
  <form class="J_ajaxForm" action="index.php?r=rbac/authorize_post" method="post">
    <div class="table_full">
      <table width="100%" cellpadding="2" cellspacing="2">
        <tr>
          <th width="130">第一级目录</th>
