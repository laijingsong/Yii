...
<div class="wrap jj">
  <ul class="nav nav-tabs">
     ...
     <li class="active"><a href="index.php?r=article/add">修改文章</a></li>
  </ul>
         ...
         <script type="text/javascript">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" class="input" name="title" value="<?php echo $article['title'];?>"></td>
            </tr>
             ...
             <tr>
              ...
              <td>内容:</td>
              <td><script type="text/plain" id="content" name="c"><?php echo $article['c'];?></script>
					<style type="text/css">
					.content_attr {
            ...
            <tr>
              <td>描述:</td>
              <td><textarea rows="" cols="" name="des"  ><?php echo $article['des'];?></textarea></td>
            </tr>
          </tbody>
        </table>
      </div>
