  ...
  <div class="common-form">
    <form method="post" class="form-horizontal J_ajaxForm" action="" enctype="multipart/form-data">
        ...
        <table cellpadding="2" cellspacing="2" class="table_form" width="100%">
         ...
         <script type="text/javascript">
          ...
          <tbody>
		   <tr>
              <td>收件人编号:</td>
              <td><input type="text" class="input" name="ToUserBh" value="<?=$data['ToUserBh']?>"></td>
            </tr> 
            <tr>
              <td width="100">消息标题:</td>
              <td><input type="text" class="input" name="title" value="<?=$data['title']?>"></td>
            </tr>
             <tr>
              <td width="100">内容:</td>
              <td><textarea rows="3" cols="20" name="content" value="<?=$data['content']?>"></textarea>
			  </td>
            </tr>
     
             <tr>
              <td>备注:</td>
              <td><input type="text" class="input" name="des" value="<?=$data['des']?>"></td>
            </tr> 
      ...
      <div class="form-actions">
            ...
            <a class="btn" href="index.php?r=message/index">返回</a>
      </div>
    </form>
  </div>
</div>