        ...
        <table cellpadding="2" cellspacing="2" class="table_form" width="100%">
          <tbody>
            <tr>
              ...
              <td><input type="text" class="input" name="name" value="<?php echo $sxinfo['name']?>"></td>
            </tr>   
            <tr>
              ...
              <select class="select_2" name="term">
              	<?php foreach ($alltype as $key=> $vo){
              		?>
              	<option value="<?php echo $vo['name']?>" <?php if ($vo['name']==$typeinfo['name']){?> selected="selected" <?php }?> ><?php echo $vo['name']?></option>
             ...
             <tr>
              <td>内容:</td>
              <td><input type="text" class="input" name="content" value="<?php echo $sxinfo['content']?>"></td>
            </tr>
            <tr>
              <td>描述:</td>
              <input type="hidden" name="bh" value="<?php echo $bh;?>">
              <td><input type="text" class="input" name="des" value="<?php echo $sxinfo['des']?>"></td>
            </tr>
