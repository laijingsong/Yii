...
<div class="wrap jj">
  <div>现在位置：<span style="color:red;"><?php echo $chima->name;?></span></div>		
        ...
        <table cellpadding="2" cellspacing="2" class="table_form" width="100%">
          <tbody>
            ...
            <tr>
              ...
              <input type="hidden" name="pbh" value="<?php echo $chima->bh;?>" />
              <input type="hidden" name="chimaid" value="<?php echo $chimaid?>" />
            </tr>
